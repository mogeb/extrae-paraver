...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/common/extrae_vector.c $
 | @last_commit: $Date: 2012-10-01 12:52:28 +0200 (Mon, 01 Oct 2012) $
 | @version:     $Revision: 1216 $
\* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- */

#include "common.h"

static char UNUSED rcsid[] = "$Id: extrae_vector.c 1216 2012-10-01 10:52:28Z harald $";
