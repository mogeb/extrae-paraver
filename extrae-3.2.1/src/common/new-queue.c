...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/common/new-queue.c $
...
static char UNUSED rcsid[] = "$Id: new-queue.c 2152 2013-09-17 12:37:30Z gllort $";
