...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/UF_gcc_instrument.h $
 | @last_commit: $Date: 2012-03-06 18:08:01 +0100 (Tue, 06 Mar 2012) $
