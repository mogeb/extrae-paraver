...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/online/extractors/Bursts.cpp $
...
static char UNUSED rcsid[] = "$Id: Bursts.cpp 2619 2014-04-17 11:54:14Z gllort $";
