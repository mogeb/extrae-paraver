...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/online/SpectralRoot.cpp $
...
static char UNUSED rcsid[] = "$Id: SpectralRoot.cpp 3460 2015-10-15 14:02:26Z gllort $";
