...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/online/SpectralWorker.cpp $
...
static char UNUSED rcsid[] = "$Id: SpectralWorker.cpp 2955 2014-09-08 10:11:01Z gllort $";
