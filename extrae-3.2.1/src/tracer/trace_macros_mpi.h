...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/trace_macros_mpi.h $
 | @last_commit: $Date: 2014-06-04 19:00:47 +0200 (Wed, 04 Jun 2014) $
