...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/wrappers/CUDA/cuda_common.h $
 | @last_commit: $Date: 2014-04-16 17:01:23 +0200 (Wed, 16 Apr 2014) $
