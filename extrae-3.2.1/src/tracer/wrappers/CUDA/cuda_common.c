...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/wrappers/CUDA/cuda_common.c $
 | @last_commit: $Date: 2015-03-10 12:45:50 +0100 (Tue, 10 Mar 2015) $
...
static char UNUSED rcsid[] = "$Id: cuda_common.c 3159 2015-03-10 11:45:50Z harald $";
