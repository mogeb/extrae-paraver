...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/tracer/wrappers/OMP/intel-kmpc-11.c $
...
static char UNUSED rcsid[] = "$Id: intel-kmpc-11.c 3250 2015-04-20 14:32:24Z harald $";
