...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/src/merger/common/addresses.c $
 | @last_commit: $Date: 2015-03-11 15:18:37 +0100 (Wed, 11 Mar 2015) $
...
static char UNUSED rcsid[] = "$Id: addresses.c 3165 2015-03-11 14:18:37Z harald $";
